(function () {
    ...
    window.custom = {
        ...
        humanizeTime(value) {
            ...
            if (timedelta < 0) {
                ...
                return 'Expires in' + Math.floor(timedelta / 60) + ' minutes'
            } else if (timedelta < 86400) {
                return 'Expires in' + Math.floor(timedelta / 3600) + ' hours'
            } else {
                return Math.floor(timedelta / 86400) + ' day and ' + Math.floor((timedelta % 86400) / 3600) + ' hours expired'
            }
        },
    ...
    window.templates = {
        ...
        noticeTemplate(data) {
            let html = ''
            if (data.length === 0) {
                html += '<li><div class="dropdown-item text-muted text-center">No notification</div></li>'
            } else {
        ...
        messageTemplate(data) {
            let html = ''
            if (data.length === 0) {
                html += '<li class="list-group-item text-center text-muted">No message record</li>'
            } else {
                for (const item of data) {
        ...
        applyTemplate(data) {
            let html = ''
            if (data.length === 0) {
                html += '<li class="list-group-item text-center text-muted">No application record</li>'
            } else {
                const badges = {
                    '0': {text: 'Unapproved', color: 'badge-info'},
                    '1': {text: 'Pass', color: 'badge-success'},
                    '2': {text: 'Not pass', color: 'badge-warning'}
                }
        ...
        loadingTemplate() {
            return `<div class="d-flex justify-content-center align-items-center text-primary">
                        <div class="spinner-border"></div><strong>loading...</strong>
                    </div>`
        },
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a class="move dropdown-item" href="javascript:void(0)">
                                    <i class="fa-solid fa-folder-open me-1"></i>move
                                </a>
                            </li>
                            <li>
                                <a class="rename dropdown-item" href="javascript:void(0)">
                                    <i class="fa-solid fa-font me-2"></i>rename
                                </a>
                            </li>
                            <li>
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a class="setup dropdown-item" href="javascript:void(0)">
                                    <i class="fa-solid fa-gear me-2"></i>Setting up the link
                                </a>
                            </li>
                            <li>
